import bpy
from warpnerf.scene.object_utilities import (
    get_active_obj_of_type,
    get_closest_parent_of_type,
    get_obj_by_id,
    is_obj_type
)
from warpnerf.scene.object_identifiers import OTYPE_NERF
...
class NeRF3DViewTrainingPanelProps(bpy.types.PropertyGroup):
    ...
    def props_for_nerf_id(self, id: any) -> NeRFProps:
